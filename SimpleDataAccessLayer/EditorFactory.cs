...
namespace SimpleDataAccessLayer
{
    ...
    public sealed class EditorFactory : IVsEditorFactory, IDisposable
    {
        ...
        public EditorFactory(SimpleDataAccessLayerPackage package)
        {
        ...
        public int CreateEditorInstance(
                        ...
                        out int pgrfCdw)
        {
            Debug.WriteLine(string.Format(CultureInfo.CurrentCulture, "Entering {0} CreateEditorInstace()", ToString()));
            ...
            var newEditor = new EditorPane(_editorPackage);
